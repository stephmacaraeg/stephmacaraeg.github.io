...
const SiteHead = ({ title }) => (
  <Head>
    <title>{title}</title>
    <meta name="title" content="Stephanie Macaraeg - Software QA Engineer" />
    <meta name="description" content="Stephanie Macaraeg - Portfolio" />
    ...
    <meta
      property="og:title"
      content="Stephanie Macaraeg - Software QA Engineer"
    />
    <meta
...
function App({ Component, pageProps }) {
  ...
  const pathToTitle = {
    "/": "Stephanie Macaraeg - Software QA Engineer",
  };
